  ...
  try {
    ...
    return {
      ...
      keywords: [
        ...
        `meilleur restaurant ${city.name}`,
        `où manger à ${city.name}`,
        `livraison repas ${city.name}`,
        `livraison de nourriture ${city.name}`,
        `menus du jour ${city.name}`,
        `réservation restaurant ${city.name}`,
        `réserver une table ${city.name}`,
        `restaurant ouvert ${city.name}`,
        `commander à manger ${city.name}`,
        `avis restaurants ${city.name}`,
        `cuisine africaine ${city.name}`,
        ...(cuisine ? [`restaurant ${cuisine} ${city.name}`, `cuisine ${cuisine} ${city.name}`] : []),
        `TérangaTable ${city.name}`,
        city.country_name,
        `restaurant ${city.country_name}`,
      ],

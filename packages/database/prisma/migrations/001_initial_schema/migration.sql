...
CREATE INDEX idx_loyalty_tenant_customer ON loyalty_transactions (tenant_id, customer_id);
CREATE INDEX idx_loyalty_tenant_created  ON loyalty_transactions (tenant_id, created_at);
...
DECLARE
  ...
  tenant_tables TEXT[] := ARRAY[
    ...
    'notifications','loyalty_transactions','pos_sessions'
  ];
BEGIN
